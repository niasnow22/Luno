...
class ShirtsItem4Screen extends StatefulWidget {
  final String name;

  const ShirtsItem4Screen({super.key, required this.name});

  @override
  State<ShirtsItem4Screen> createState() => _ShirtsItem4ScreenState();
}

class _ShirtsItem4ScreenState extends State<ShirtsItem4Screen> {
