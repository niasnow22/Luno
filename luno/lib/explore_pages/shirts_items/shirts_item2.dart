...
class ShirtsItem2Screen extends StatefulWidget {
  final String name;

  const ShirtsItem2Screen({super.key, required this.name});

  @override
  State<ShirtsItem2Screen> createState() => _ShirtsItem2ScreenState();
}

class _ShirtsItem2ScreenState extends State<ShirtsItem2Screen> {
