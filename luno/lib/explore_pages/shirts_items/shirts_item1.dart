...
class ShirtsItem1Screen extends StatefulWidget {
  final String name;

  const ShirtsItem1Screen({super.key, required this.name});

  @override
  State<ShirtsItem1Screen> createState() => _ShirtsItem1ScreenState();
}

class _ShirtsItem1ScreenState extends State<ShirtsItem1Screen> {
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ShirtScreen(name: widget.name),
                          ),
                        );
                      },
                    ),
