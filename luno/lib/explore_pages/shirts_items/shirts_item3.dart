...
class ShirtsItem3Screen extends StatefulWidget {
  final String name;

  const ShirtsItem3Screen({super.key, required this.name});

  @override
  State<ShirtsItem3Screen> createState() => _ShirtsItem3ScreenState();
}

class _ShirtsItem3ScreenState extends State<ShirtsItem3Screen> {
