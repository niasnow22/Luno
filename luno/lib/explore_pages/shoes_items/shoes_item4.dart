...
class ShoesItem4Screen extends StatefulWidget {
  final String name;

  const ShoesItem4Screen({super.key, required this.name});

  @override
  State<ShoesItem4Screen> createState() => _ShoesItem4ScreenState();
}

class _ShoesItem4ScreenState extends State<ShoesItem4Screen> {
