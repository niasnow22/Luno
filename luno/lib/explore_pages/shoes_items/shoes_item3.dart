...
class ShoesItem3Screen extends StatefulWidget {
  final String name;

  const ShoesItem3Screen({super.key, required this.name});

  @override
  State<ShoesItem3Screen> createState() => _ShoesItem3ScreenState();
}

class _ShoesItem3ScreenState extends State<ShoesItem3Screen> {
