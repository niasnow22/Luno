...
class ShoesItem2Screen extends StatefulWidget {
  final String name;

  const ShoesItem2Screen({super.key, required this.name});

  @override
  State<ShoesItem2Screen> createState() => _ShoesItem2ScreenState();
}

class _ShoesItem2ScreenState extends State<ShoesItem2Screen> {
