...
class ShoesItem1Screen extends StatefulWidget {
  final String name;

  const ShoesItem1Screen({super.key, required this.name});

  @override
  State<ShoesItem1Screen> createState() => _ShoesItem1ScreenState();
}

class _ShoesItem1ScreenState extends State<ShoesItem1Screen> {
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ShoesScreen(name: widget.name),
                          ),
                        );
                      },
                    ),
