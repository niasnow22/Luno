...
class DressItem1Screen extends StatefulWidget {
  final String name;

  const DressItem1Screen({super.key, required this.name});

  @override
  State<DressItem1Screen> createState() => _DressItem1ScreenState();
}

class _DressItem1ScreenState extends State<DressItem1Screen> {
  ...
  Future<void> _checkFavoriteStatus() async {
    bool status = await FavoriteDatabase.instance.isFavorite('Scalloped Flower Dress');
    setState(() {
      isFavorite = status;
    });
  }
