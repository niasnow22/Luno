...
class DressItem3Screen extends StatefulWidget {
  final String name;

  const DressItem3Screen({super.key, required this.name});

  @override
  State<DressItem3Screen> createState() => _DressItem3ScreenState();
}

class _DressItem3ScreenState extends State<DressItem3Screen> {
  ...
  Future<void> _checkFavoriteStatus() async {
    bool status = await FavoriteDatabase.instance.isFavorite('Plaid Dress');
    setState(() {
      isFavorite = status;
    });
  }
