...
class DressItem2Screen extends StatefulWidget {
  ...
  const DressItem2Screen({super.key, required this.name});

  @override
  State<DressItem2Screen> createState() => _DressItem2ScreenState();
}

class _DressItem2ScreenState extends State<DressItem2Screen> {
