...
class SalesItem4Screen extends StatefulWidget {
  final String name;

  const SalesItem4Screen({super.key, required this.name});

  @override
  State<SalesItem4Screen> createState() => _SalesItem4ScreenState();
}

class _SalesItem4ScreenState extends State<SalesItem4Screen> {
