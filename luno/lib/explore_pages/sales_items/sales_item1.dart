...
class SalesItem1Screen extends StatefulWidget {
  final String name;

  const SalesItem1Screen({super.key, required this.name});

  @override
  State<SalesItem1Screen> createState() => _SalesItem1ScreenState();
}

class _SalesItem1ScreenState extends State<SalesItem1Screen> {
