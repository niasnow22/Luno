...
class SalesItem2Screen extends StatefulWidget {
  final String name;

  const SalesItem2Screen({super.key, required this.name});

  @override
  State<SalesItem2Screen> createState() => _SalesItem2ScreenState();
}

class _SalesItem2ScreenState extends State<SalesItem2Screen> {
