...
class PantsItem3Screen extends StatefulWidget {
  final String name;

  const PantsItem3Screen({super.key, required this.name});

  @override
  State<PantsItem3Screen> createState() => _PantsItem3ScreenState();
}

class _PantsItem3ScreenState extends State<PantsItem3Screen> {
