...
class PantsItem2Screen extends StatefulWidget {
  final String name;

  const PantsItem2Screen({super.key, required this.name});

  @override
  State<PantsItem2Screen> createState() => _PantsItem2ScreenState();
}

class _PantsItem2ScreenState extends State<PantsItem2Screen> {
