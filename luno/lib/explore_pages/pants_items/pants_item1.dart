...
class PantsItem1Screen extends StatefulWidget {
  final String name;

  const PantsItem1Screen({super.key, required this.name});

  @override
  State<PantsItem1Screen> createState() => _PantsItem1ScreenState();
}

class _PantsItem1ScreenState extends State<PantsItem1Screen> {
  ...
  final List<String> colors = ['Black', 'White', 'Beige'];
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (_) => PantsScreen(name: widget.name),
                          ),
                        );
                      },
                    ),
