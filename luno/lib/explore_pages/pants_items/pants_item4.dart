...
class PantsItem4Screen extends StatefulWidget {
  final String name;

  const PantsItem4Screen({super.key, required this.name});

  @override
  State<PantsItem4Screen> createState() => _PantsItem4ScreenState();
}

class _PantsItem4ScreenState extends State<PantsItem4Screen> {
